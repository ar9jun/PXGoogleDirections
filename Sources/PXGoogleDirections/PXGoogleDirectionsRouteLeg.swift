...
@objc public class PXGoogleDirectionsRouteLeg: NSObject, PXGoogleDirectionsSteppable {
    ...
    @objc public func getEndLocation() -> CLLocationCoordinate2D {
        if let e = endLocation {
            return e
        }
