...
@objc public class PXGoogleDirectionsRouteLegStep: NSObject, PXGoogleDirectionsSteppable {
    /// Formatted instructions for this step, presented as an HTML text string
    @objc public var htmlInstructions: String?
    /// Coded instructions for this step, for use in GPS or navigation-based applications
    @objc public var maneuver: String?
    ...
    @objc public var polyline: String?
    /// Detailed directions for walking or driving steps in transit directions (only available for transit mode directions)
    @objc public var steps: [PXGoogleDirectionsRouteLegStep] = [PXGoogleDirectionsRouteLegStep]()
    ...
    @objc public var transitDetails: PXGoogleDirectionsRouteLegStepTransitDetails?
    /// Returns the corresponding `GMSPath` object associated with this route step
    @objc public var path: GMSPath? {
        if let p = polyline {
    ...
    @objc public var rawInstructions: String? {
    ...
    @objc public func getTravelMode() -> String {
        if let tm = travelMode {
