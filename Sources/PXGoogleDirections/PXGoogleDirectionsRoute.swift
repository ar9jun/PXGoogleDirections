...
@objc public class PXGoogleDirectionsRoute: NSObject {
    ...
    @objc public var legs: [PXGoogleDirectionsRouteLeg] = [PXGoogleDirectionsRouteLeg]()
    ...
    @objc public var waypointsOrder: [Int] = [Int]()
    ...
    @objc public var overviewPolyline: String?
    /// Viewport bounding box of the `overviewPolyline`
    @objc public var bounds: GMSCoordinateBounds?
    /// Copyrights text to be displayed for this route
    @objc public var copyrights: String?
    /// Array of warnings to be displayed when showing these directions
    @objc public var warnings: [String] = [String]()
    ...
    @objc public var fare: PXGoogleDirectionsRouteFare?
    ...
    @objc public var encodedPath: String {
        if let p = path {
    ...
    @objc public var detailedPath: GMSPath? {
