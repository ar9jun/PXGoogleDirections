...
@objc public class PXGoogleDirectionsRouteLegStepTransitDetails: NSObject {
    /// Information about the starting station for this part of the trip
    @objc public var arrivalStop: PXGoogleDirectionsStop?
    /// Information about the stop station for this part of the trip
    @objc public var departureStop: PXGoogleDirectionsStop?
    ...
    @objc public var headsign: String?
    ...
    @objc public var line: PXGoogleDirectionsTransitLine?
}
