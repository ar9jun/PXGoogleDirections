...
@objc public class PXGoogleDirections: NSObject {
    ...
    @objc public static var apiBaseURL: String { return _apiBaseURL }
    ///    Returns `true` if the Google Maps app is installed and can open places and directions URLs, `false` otherwise
    @objc public static var canOpenInGoogleMaps: Bool {
    ...
    @objc public var delegate: PXGoogleDirectionsDelegate?
    ...
    */
    @objc public var directionsAPIRequestURL: URL? {
        ...
        if let f = from, let t = to {
            ...
            // Handle @objc public transit mode
            ...
            // Handle @objc public transit routing preference
    ...
    */
    ...
    @objc public func setMode(_ modeSet: PXGoogleDirectionsMode) {
        mode = modeSet
    }
    @objc public func setDirectionUnit(_ unitSet: PXGoogleDirectionsUnit) {
        units = unitSet
    }
    ...
    */
    @objc public func calculate(_ completion: @escaping (PXGoogleDirections?, [PXGoogleDirectionsRoute], Error?) -> Void) {
        calculateDirections { (response) in
            switch response {
            case let .error(_, error):
                completion(nil, [], error)
            case let .success(request, routes):
                completion(request, routes, nil)
            }
        }
    }
